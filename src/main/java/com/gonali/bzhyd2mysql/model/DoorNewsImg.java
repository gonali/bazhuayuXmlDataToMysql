 ...
 */
public class DoorNewsImg implements TableModel{
    ...
    public DoorNewsImg(String domain, String articleRawUrl, String articleTitle, String imgSrcUrl,
                       boolean isDownload, String imgName, String savePath, String crawlTime) {
        this.domain = domain;
    ...
    public String getMysqlInsertSql(String tableName) {
        ...
        sql = "INSERT INTO " + tableName + " " +
                "(domain,articleRawUrl,articleTitle,imgSrcUrl,isDownload,imgName,savePath,crawlTime)" +
                "VALUES('" + domain + "','" + articleRawUrl + "','" + articleTitle + "','" + imgSrcUrl + "'," + isDownload + ",'" +
